"""
Django settings for hesbon_frd_1 project.
...
ROOT_URLCONF = 'hesbon_frd_1.urls'
...
WSGI_APPLICATION = 'hesbon_frd_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hesbon_frd_1 API",
    "DESCRIPTION": "API documentation for hesbon_frd_1 App",
    "VERSION": "v1",
}
